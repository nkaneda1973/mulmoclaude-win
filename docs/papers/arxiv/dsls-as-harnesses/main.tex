...
deployment in which 26 applications, 6 bespoke sandboxed UI views, and 3 external
feeds accreted over roughly two months without any host code being written per
application. We discuss the design's principal hazard---the escape hatch from the
