...
// regex note: markdown task-line parser, bounded captures with hard delimiters
...
// regex note: bounded blockquote-prefix parser; `\s*` / `>\s?` / outer `+` operate on disjoint character classes (no overlap)
