...
const ptBRMessages = {
  ...
  collectionsView: {
    ...
    addViewPrompt:
      'Quero adicionar uma visualização personalizada à coleção "{title}". Pergunte o que eu quero ver ou editar, depois crie o arquivo HTML da visualização em data/skills/{slug}/views/<name>.html e registre-o no schema.json da coleção em `views[]` (capabilities ["read"] para uma visualização somente leitura, ["read","write"] se editar registros). Siga a ajuda custom-view para o contrato de dados.',
    repair: "Reparar",
