...
const zhMessages = {
  ...
  collectionsView: {
    ...
    addViewPrompt:
      '我想为“{title}”集合添加一个自定义视图。先问我想查看或编辑什么，然后在 data/skills/{slug}/views/<name>.html 创建 HTML 视图文件，并在该集合 schema.json 的 `views[]` 中注册（只读视图用 capabilities ["read"]，需要编辑记录则用 ["read","write"]）。数据契约请遵循 custom-view 帮助文档。',
    repair: "修复",
