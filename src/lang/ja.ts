...
const jaMessages = {
  ...
  collectionsView: {
    ...
    addViewPrompt:
      '「{title}」コレクションにカスタムビューを追加したい。何を見たい／編集したいか質問してから、HTML ビューファイルを data/skills/{slug}/views/<name>.html に作成し、コレクションの schema.json の `views[]` に登録して（読み取り専用なら capabilities ["read"]、レコードを編集するなら ["read","write"]）。データ契約は custom-view ヘルプに従ってください。',
    repair: "修復",
