...
const deMessages = {
  ...
  collectionsView: {
    ...
    addViewPrompt:
      'Ich möchte der Sammlung {title} eine benutzerdefinierte Ansicht hinzufügen. Frag mich, was ich sehen oder bearbeiten möchte, erstelle dann die HTML-Ansichtsdatei unter data/skills/{slug}/views/<name>.html und registriere sie in der schema.json der Sammlung unter `views[]` (capabilities ["read"] für eine schreibgeschützte Ansicht, ["read","write"] wenn sie Datensätze bearbeitet). Folge der custom-view-Hilfe für den Datenvertrag.',
    repair: "Reparieren",
