...
const enMessages = {
  ...
  collectionsView: {
    ...
    addViewPrompt:
      'I want to add a custom view to the "{title}" collection. Ask me what I want to see or edit, then author the HTML view file at data/skills/{slug}/views/<name>.html and register it in the collection\'s schema.json under `views[]` (capabilities ["read"] for a read-only view, ["read","write"] if it edits records). Follow the custom-view help for the data contract.',
    repair: "Repair",
